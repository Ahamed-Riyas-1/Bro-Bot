...
(0, vitest_1.test)('Takes in a keyPair object and returns tweetnacl secretkey format in Uint8Array', () => {
    const keyPair = {
    ...
    const actual = (0, toTweetNaclSecretKey_1.toTweetNaclSecretKey)(keyPair);
...
//# sourceMappingURL=toTweetNaclSecretKey.test.js.map