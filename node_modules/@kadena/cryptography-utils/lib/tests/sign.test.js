...
(0, vitest_1.test)('Takes in a message and keypair, outputs an object with "hash", "sig", and "pubKey" in hex format.', () => {
    const str = JSON.stringify(Pact_1.pactTestCommand);
    const keyPair = {
    ...
    const actualSigWithHash = (0, sign_1.sign)(str, keyPair);
    ...
    (0, vitest_1.expect)(actualSigWithHash).toEqual(expectedSigWithHash);
});
